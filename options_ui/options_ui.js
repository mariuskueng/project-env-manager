;(function () {
  ...
  function wire() {
    ...
    $("#save").addEventListener("click", saveProjects)
    $("#exportConfig").addEventListener("click", exportConfig)
    $("#importFile").addEventListener("change", importConfig)
    $("#importFromUpsun").addEventListener("click", window.importFromUpsun)
  }
  ...
  // set globales
  window.showWholePageSpinner = showWholePageSpinner
  window.hideWholePageSpinner = hideWholePageSpinner
